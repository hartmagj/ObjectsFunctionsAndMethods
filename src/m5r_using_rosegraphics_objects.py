...
#            creates a delay before rendering the next window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            at the end of the executed code within that window, to close it and move on to the next window.
#            It lets the computer know when the user is done looking at the first window so it can move on to the next.
#
