...
def try_methods():
    ...
    Then makes the SimpleTurtle move as follows (in the order listed):
      ...
      -- backward  100 units
    """
    tod = rg.SimpleTurtle("triangle")
    tod.pen = rg.Pen("brown", 5)
    tod.forward(150)
    tod.left(90)
    tod.forward(50)
    tod.backward(100)
...
def try_methods_and_functions():
    ...
    tod.pen = rg.Pen("blue", 5)

    tod.backward(150)
    tod.speed = 1
    draw_many_squares(tod, 2, 100, 30)
    tod.speed = 5
    tod.pen = rg.Pen("red", 5)
    draw_many_squares(tod, 10, 50, 15)
    tod.speed = 100
    tod.pen = rg.Pen("red", 35)
    draw_many_squares(tod, 8, 300, 60)
    tod.pen = rg.Pen("black", 3)
    tod.backward(200)
    tod.draw_circle(30)
    tod.draw_square(50)
    ####################################################################
